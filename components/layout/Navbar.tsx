...
export default function Navbar() {
  ...
  const activeHref = mounted ? (pathname === "/" ? "/" : pathname) : "/";
  ...
  return (
    <header
      ...
      } container mx-auto fixed top-0 left-0 right-0 w-full z-[100] transition-colors duration-300 border-t-2 border-primary`}
    >
      ...
      <div
        ...
        } bg-white border-t border-gray-100 shadow-lg w-full`}
      >
        <div className="w-full px-4 py-6">
          <div className="flex flex-col space-y-4">
            ...
            <Link
              href="tel:+15095921745"
              className="bg-primary text-white font-semibold text-sm py-2 px-6 rounded-md hover:bg-primary/90 hover:scale-105 hover:shadow-lg hover:shadow-primary/25 transition-all duration-300 transform w-full text-center"
              onClick={() => setIsOpen(false)}
            >
              Contact Us
            </Link>
